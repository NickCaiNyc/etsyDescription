...
admin.initializeApp({
  ...
  storageBucket: process.env.FIREBASE_BUCKET, // Ensure correct bucket name
});
...
app.post('/upload', upload.array('images', 10), async (req, res) => {
  try {
    ...
    const description = await generateDescription(folderName, urls); //need to change... not foldername
